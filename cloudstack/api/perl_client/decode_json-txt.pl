...
print "id,instancename,name,state,haenable,created,cpunumber,cpuspeed,memory,rootdeviceid,rootdeivcetype,serviceofferingid,serviceofferingname,domain,domainid,account,hypervisor,macaddress,ipaddress,networkid,publicipid,publicip,hostname,hostid,zoneid,zonename,displayname\n";
